  ...
  return (
    <nav className="flex justify-between text-white w-screen">
      <div className="px-5 xl:px-12 py-6 flex w-full items-center">
        <Link to='/'>
          <img className='col-span-2 max-h-12 w-full object-contain lg:col-span-1' src="./src/image.png" alt="Logo image" />
        </Link>
        {/* Nav Links */}
        ...
        <div className="hidden xl:flex items-center space-x-5 items-center">
          ...
          {/* Sign In / Register      */}
          <Link className="flex items-center hover:text-gray-200" href="#" to='/profile'>
          {
          currentUser?(
          <svg
            xmlns="http://www.w3.org/2000/svg"
