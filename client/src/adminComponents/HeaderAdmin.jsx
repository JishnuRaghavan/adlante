...
<svg className="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="26.536" height="26" viewBox="0 0 26.536 26">
...
<svg className="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="33.674" height="26" viewBox="0 0 33.674 26">
...
<svg className="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="28.08" height="26.196" viewBox="0 0 28.08 26.196">
...
<span className="sherah-header__message--animate sherah-color3__bg--light"><span className="sherah-color3__bg"></span></span>
<div className="sherah-dropdown-card sherah-dropdown-card__alarm sherah-border">
<svg className="sherah-dropdown-arrow" xmlns="http://www.w3.org/2000/svg" width="43.488" height="22.207" viewBox="0 0 43.488 22.207">
...
<h3 className="sherah-dropdown-card__title sherah-border-btm">Recent Message</h3>
...
<img src="admin-asset/img/chat-author1.png" alt="#"/>
...
<p className="sherah-chatbox__author-desc">Hey! You forgot your keys....</p>
</div>
</div>
</div>
</li>
...
<div className="sherah-chatbox__author">
<div className="sherah-chatbox__author-img">
<img src="admin-asset/img/chat-author2.png" alt="#"/>
...
<span className="sherah-chatbox__unread sherah-color1__bg">5</span>
</div>
</div>
</li>
...
<div className="sherah-chatbox__author">
<div className="sherah-chatbox__author-img">
<img src="admin-asset/img/chat-author4.png" alt="#"/>
<span className="sherah-chatbox__author-online"></span>
</div>
<div className="sherah-chatbox__author-content">
<h4 className="sherah-chatbox__author-title">Rose Rovert</h4>
<p className="sherah-chatbox__author-desc">Of course I work the finaly done ....</p>
</div>
</div>
</div>
</li>
...
<div className="sherah-chatbox__author">
<div className="sherah-chatbox__author-img">
<img src="admin-asset/img/chat-author5.png" alt="#"/>
<span className="sherah-chatbox__author-online author-is-busy"></span>
</div>
<div className="sherah-chatbox__author-content">
<h4 className="sherah-chatbox__author-title">Mahstai</h4>
<p className="sherah-chatbox__author-desc">Any plan for today?</p>
</div>
</div>
<div className="sherah-chatbox__right">
<span className="sherah-chatbox__unread sherah-color1__bg">7</span>
</div>
</div>
</li>
...
<div className="sherah-dropdown-card__button"><a href="chat-messages.html" className="sherah-dropdown-card__sell-all">See all Notification</a></div>
</div>
...
<svg className="sherah-offset__fill" id="Icon" xmlns="http://www.w3.org/2000/svg" width="22.875" height="25.355" viewBox="0 0 22.875 25.355">
...
<span className="sherah-header__count sherah-color1__bg">4</span>

<div className="sherah-dropdown-card sherah-dropdown-card__alarm sherah-border">
<svg className="sherah-dropdown-arrow" xmlns="http://www.w3.org/2000/svg" width="43.488" height="22.207" viewBox="0 0 43.488 22.207">
<path id="Path_1271" data-name="Path 1271" d="M-15383,7197.438l20.555-20.992,20.555,20.992Z" transform="translate(15384.189 -7175.73)" stroke-width="1" />
</svg>
<h3 className="sherah-dropdown-card__title sherah-border-btm">Recent Notification</h3>
...
<h4 className="sherah-notifications__title">You have an offer! <span>successfully done</span></h4>
<p className="sherah-paymentm__text sherah-paymentm__text--notify">20 minutes ago</p>
</div>
</div>
</li>
<li>
...
<div className="sherah-paymentm__content">
<h4 className="sherah-notifications__title">You upload your fast product <span>successfully done</span></h4>
<p className="sherah-paymentm__text sherah-paymentm__text--notify">3 hours ago </p>
</div>
</div>
</li>
<li>
...
<div className="sherah-paymentm__content">
<h4 className="sherah-notifications__title">Your Account has been created <span>successfully done</span></h4>
<p className="sherah-paymentm__text sherah-paymentm__text--notify">5 hours ago</p>
</div>
</div>
</li>
<li>
...
<div className="sherah-paymentm__content">
<h4 className="sherah-notifications__title">Thank you !you made your fast sell <span>$120</span></h4>
<p className="sherah-paymentm__text sherah-paymentm__text--notify">6 hours ago</p>
</div>
</div>
</li>
</ul>

<div className="sherah-dropdown-card__button"><a href="notifications.html" className="sherah-dropdown-card__sell-all">See all Notification</a></div>
</div>
...
<img src="admin-asset/img/profile-pic.png" alt="#"/>
</div>
<div className="sherah-header__author--info sherah-dflex sherah-dflex__base">
<h4 className="sherah-header__author--title  sherah-dflex sherah-dflex__column">Anthony <span className="sherah-header__author--text">USA</span></h4>
<svg className="sherah-default__fill sherah-default__arrow" xmlns="http://www.w3.org/2000/svg" width="10.621" height="5.836" viewBox="0 0 10.621 5.836">
...
<h3 className="sherah-dropdown-card__title sherah-border-btm">My Profile</h3>
...
<h4 className="sherah-dropdown-card-name"><a href="profile-info.html">My Profile</a></h4>
</div>
</li>
<li>
<div className="sherah-dropdown-card-info">
...
<h4 className="sherah-dropdown-card-name "><a href="chat-messages.html">Message</a></h4>
</div>
</li>
<li>
<div className="sherah-dropdown-card-info">
...
<h4 className="sherah-dropdown-card-name"><a href="profile-info.html">Settings</a></h4>
</div>
</li>
<li>
<div className="sherah-dropdown-card-info">
...
<h4 className="sherah-dropdown-card-name"><a href="#">Logout</a></h4>
</div>
</li>
</ul>
</div>
