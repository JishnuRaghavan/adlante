...
<div className="logo sherah-sidebar-padding">
  <a href="index-2.html">
    <img className="sherah-logo__main" src="admin-asset/img/logo.png" alt="#" />
  </a>
...
<li><a href="#!" data-bs-toggle="collapse" data-bs-target="#menu-item_home"><span className="menu-bar__text">
...
<li><a href="#!" className="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item_vendors"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
<svg className="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="22.038" height="17.943" viewBox="0 0 22.038 17.943">
...
<span className="menu-bar__name">Vendors</span> <span className="sherah__toggle"></span></span></a>
</li>
<div className="collapse sherah__dropdown" id="menu-item_vendors" data-bs-parent="#sherahMenu">
<ul className="menu-bar__one-dropdown">
<li><a href="vendor.html"><span className="menu-bar__text"><span className="menu-bar__name">Vendor Grid</span></span></a></li>
<li><a href="vendor-list.html"><span className="menu-bar__text"><span className="menu-bar__name">Vendor List</span></span></a></li>
<li><a href="vendor-profile.html"><span className="menu-bar__text"><span className="menu-bar__name">Vendor Profile</span></span></a></li>
</ul>
</div>

<li><a href="#!" className="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__customers"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
...
<span className="menu-bar__name">Customers</span> <span className="sherah__toggle"></span></span></a>
</li>
<div className="collapse sherah__dropdown" id="menu-item__customers" data-bs-parent="#sherahMenu">
<ul className="menu-bar__one-dropdown">
<li><a href="customer-list.html"><span className="menu-bar__text"><span className="menu-bar__name">Customer List</span></span></a></li>
<li><a href="customers.html"><span className="menu-bar__text"><span className="menu-bar__name">Customers</span></span></a></li>
</ul>
</div>

<li><a href="#!" className="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item_products"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
...
<span className="menu-bar__name">Products</span> <span className="sherah__toggle"></span></span></a>
...
<li><a href="wishlist.html" className="collapsed"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
<svg className="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="22.259" height="19.146" viewBox="0 0 22.259 19.146">
...
<span className="menu-bar__name">Wishlist</span></span></a>
</li>
<li><a href="#!" className="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__orders"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
...
<span className="menu-bar__name">Orders</span><span className="sherah__toggle"></span></span></a>

<div className="collapse sherah__dropdown" id="menu-item__orders" data-bs-parent="#sherahMenu">
<ul className="menu-bar__one-dropdown">
<li><a href="order-list.html"><span className="menu-bar__text"><span className="menu-bar__name">Order List</span></span></a></li>
<li><a href="order-details.html"><span className="menu-bar__text"><span className="menu-bar__name">Order Details</span></span></a></li>
</ul>
</div>
</li>
<li><a href="invoice.html" className="collapsed"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
<svg className="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="19.434" height="19.432" viewBox="0 0 19.434 19.432">
...
<span className="menu-bar__name">Invoice</span></span></a>
</li>
<li><a href="history.html" className="collapsed"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
<svg className="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="19.527" height="19.582" viewBox="0 0 19.527 19.582">
...
<span className="menu-bar__name">History</span></span></a>
</li>
<li><a className="collapsed" href="profile-info.html"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
...
<span className="menu-bar__name">Settings</span></span></a>
</li>
<li><a href="chat-messages.html" className="collapsed"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
<svg className="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="22.029" height="22.368" viewBox="0 0 22.029 22.368">
...
<span className="menu-bar__name">Message</span></span></a>
</li>
<li><a href="#!" className="collapsed" data-bs-toggle="collapse" data-bs-target="#menu-item__9"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
<svg className="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="22.029" height="20.972" viewBox="0 0 22.029 20.972">
...
<span className="menu-bar__name">Pages</span><span className="sherah__toggle"></span></span></a>

<div className="collapse sherah__dropdown" id="menu-item__9" data-bs-parent="#sherahMenu">
<ul className="menu-bar__one-dropdown">
<li><a href="notifications.html"><span className="menu-bar__text"><span className="menu-bar__name">Notifications</span></span></a></li>
<li><a href="terms-conditions.html"><span className="menu-bar__text"><span className="menu-bar__name">Terms & Conditions</span></span></a></li>
<li><a href="faq.html"><span className="menu-bar__text"><span className="menu-bar__name">Faqs</span></span></a></li>
</ul>
</div>
</li>
<li><a className="collapsed" href="languages.html"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
<svg className="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="20.929" height="20.929" viewBox="0 0 20.929 20.929">
...
<span className="menu-bar__name">Language</span></span></a>
</li>
<li><a className="collapsed" href="login.html"><span className="menu-bar__text">
<span className="sherah-menu-icon sherah-svg-icon__v1">
<svg className="sherah-svg-icon" xmlns="http://www.w3.org/2000/svg" width="19.103" height="23.047" viewBox="0 0 19.103 23.047">
...
<span className="menu-bar__name">Login</span></span></a>
</li>
</ul>
</div>
