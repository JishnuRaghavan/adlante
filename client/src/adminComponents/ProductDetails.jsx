...
<li><a href="#">Home</a></li>
<li className="active"><a href="products.html">Products Details</a></li>
</ul>
</div>
...
<ul className="nav-pills nav flex-nowrap product-thumbs" id="pills-tab" role="tablist">
<li className="single-thumbs" role="presentation">
<a className="active" id="pills-home-tab" data-bs-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true">
<img src="admin-asset/img/product-detail.png" alt="thumbs"/>
</a>
</li>
<li className="single-thumbs" role="presentation">
<a id="pills-profile-tab" data-bs-toggle="pill" href="#pills-profile" role="tab" aria-controls="pills-profile" aria-selected="false">
<img src="admin-asset/img/product-detail.png" alt="thumbs"/>
</a>
</li>
<li className="single-thumbs" role="presentation">
<a id="pills-contact-tab" data-bs-toggle="pill" href="#pills-contact" role="tab" aria-controls="pills-contact" aria-selected="false">
<img src="admin-asset/img/product-detail.png" alt="thumbs"/>
</a>
</li>
<li className="single-thumbs" role="presentation">
<a id="pills-four-tab" data-bs-toggle="pill" href="#pills-four" role="tab" aria-controls="pills-four" aria-selected="false">
<img src="admin-asset/img/product-detail.png" alt="thumbs"/>
</a>
</li>
</ul>
...
<img src="admin-asset/img/product-detail.png" alt="product"/>
</div>
...
<h2 className="product-detail-body__title">Atu Body Couture Bow Front Dress</h2>
<p className="product-detail-body__stats">Sold 21 Products in last 10 Hours</p>
...
To achieve this, it would be necessary to have uniform grammar pronunciation and more our common words If several languages coalesce
</div>
...
<input type="text" name="quant[1]" className="input-number" data-min="1" data-max="10" value="0"/>
...
<a href="#" className="sherah-btn">Add to Cart</a>
...
<li><span className="p-list-title">SKU :</span> KE-91039 </li>
<li><span className="p-list-title">Category : </span> Cloth</li>
<li><span className="p-list-title">Tags :</span> Grown Dress, Dress, Party Dress </li>
<li>
<span className="p-list-title">Share:</span>
<ul className="sherah-contact-info sherah-contact-social">
<li className="sherah-border"><a href="#"><span className="sherah-color1__bg--offset"><i className="fa-brands fa-facebook-f"></i></span></a></li>
<li className="sherah-border"><a href="#"><span className="sherah-color1__bg--offset"><i className="fa-brands fa-twitter"></i></span></a></li>
<li className="sherah-border"><a href="#"><span className="sherah-color1__bg--offset"><i className="fa-brands fa-linkedin"></i></span></a></li>
<li className="sherah-border"><a href="#"><span className="sherah-color1__bg--offset"><i className="fa-brands fa-instagram"></i></span></a></li>
</ul>
</li>
</ul>
</div>
...
<div className="sherah-product-tabs__list list-group " id="list-tab" role="tablist">
<a className="list-group-item active" data-bs-toggle="list" href="#p_tab_1" role="tab" >Specifications</a>
<a className="list-group-item" data-bs-toggle="list" href="#p_tab_2" role="tab">Features</a>
<a className="list-group-item" data-bs-toggle="list" href="#p_tab_3" role="tab">Reviews</a>
</div>
</div>
</div>
</div>
...
<div className="tab-pane fade show active" id="p_tab_1" role="tabpanel" aria-labelledby="nav-home-tab">
<div className="sherah-product-tabs__text">
<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you aare going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words,</p>
</div>
<div className="sherah-table p-0">
<table className="product-overview-table mg-top-30">
<tbody>
<tr>
<td><span className="product-overview-table_title">Package Dimensions</span></td>
<td><span className="product-overview-table_text">44 x 32 x 4 cm, 560 Grams</span></td>
</tr>
<tr>
<td><span className="product-overview-table_title">Manufacturer</span></td>
<td><span className="product-overview-table_text">Badgley Mischka</span></td>
</tr>
<tr>
<td><span className="product-overview-table_title">Product Part Number</span></td>
<td><span className="product-overview-table_text">JKGHNBKJG-MN563205</span></td>
</tr>
<tr>
<td><span className="product-overview-table_title">Best Sellers Rank</span></td>
<td><span className="product-overview-table_text">#561 in Clothing and Accessories</span></td>
</tr>
<tr>
<td><span className="product-overview-table_title">Customer Reviews</span></td>
<td>
<div className="sherah-product-card__meta sherah-dflex sherah-flex-gap-30">
<div className="sherah-product-card__rating sherah-dflex sherah-flex-gap-5">
<span className="sherah-color4"><i className="fa fa-star"></i></span>
...
<span className="sherah-color4"><i className="fa fa-star"></i></span>
<span className="sherah-color4"><i className="fa fa-star"></i></span>
<span className="sherah-color4"><i className="fa-regular fa-star"></i></span>
2,580 Ratings
</div>
</div>
</td>
...
<div className="tab-pane fade" id="p_tab_2" role="tabpanel" aria-labelledby="nav-home-tab">
<ul className="sherah-features-list">
<li><svg className="sherah-offset__fill" xmlns="http://www.w3.org/2000/svg" width="12" height="11" viewBox="0 0 12 11">
...
<div className="tab-pane fade" id="p_tab_3" role="tabpanel" aria-labelledby="nav-home-tab">

<div className="sherah-user-reviews">

<div className="sherah-user-reviews__single">
<div className="shera-user-reviews_thumb">
<img src="admin-asset/img/review-1.png"/>
</div>
<div className="sherah-user-reviews__content">
<h4 className="sherah-user-reviews_title">Abubokkor Siddik</h4>
<div className="sherah-product-card__rating sherah-dflex sherah-flex-gap-5">
<span className="sherah-color4"><i className="fa fa-star"></i></span>
<span className="sherah-color4"><i className="fa fa-star"></i></span>
<span className="sherah-color4"><i className="fa fa-star"></i></span>
...
<p className="sherah-user-reviews__text">This is some unreal beauty!I really liked it! What a beautiful light it comes from! The radius of bright light is about meters</p>
...
<div className="shera-user-reviews_thumb">
<img src="admin-asset/img/review-2.png"/>
</div>
<div className="sherah-user-reviews__content">
<h4 className="sherah-user-reviews_title">Admin</h4>
<div className="sherah-product-card__rating sherah-dflex sherah-flex-gap-5">
<span className="sherah-color4"><i className="fa fa-star"></i></span>
<span className="sherah-color4"><i className="fa fa-star"></i></span>
<span className="sherah-color4"><i className="fa fa-star"></i></span>
...
<p className="sherah-user-reviews__text">Thank Your for opinion.</p>
<div className="sherah-user-reviews__buttons">
<a href="#" className="sherah-color3 sherah-color3__bg--opactity">
<svg xmlns="http://www.w3.org/2000/svg" width="17.136" height="15.5" viewBox="0 0 17.136 15.5">
<path id="Icon" d="M106.729,13.669v.694a.779.779,0,0,0-.022.1,5.407,5.407,0,0,1-.909,2.507,10.756,10.756,0,0,1-1.877,2.153c-1.417,1.265-2.855,2.505-4.29,3.75a.9.9,0,0,1-1.28-.03q-1.646-1.415-3.287-2.836a17.082,17.082,0,0,1-2.561-2.63,5.638,5.638,0,0,1-1.136-2.513,4.777,4.777,0,0,1,1.049-4.005,4.03,4.03,0,0,1,3.775-1.423,3.938,3.938,0,0,1,2.419,1.328c.138.149.264.31.4.477.069-.089.128-.169.192-.246s.135-.162.208-.239A3.931,3.931,0,0,1,103.71,9.6a4.192,4.192,0,0,1,2.863,3.17C106.65,13.062,106.679,13.368,106.729,13.669Z" transform="translate(-90.443 -8.519)" fill="none" stroke="#09ad95" stroke-width="1.7" />
...
<div className="sherah-user-reviews__single">
<div className="shera-user-reviews_thumb">
<img src="admin-asset/img/review-3.png"/>
</div>
<div className="sherah-user-reviews__content">
<h4 className="sherah-user-reviews_title">Deniella Rhodes</h4>
<div className="sherah-product-card__rating sherah-dflex sherah-flex-gap-5">
<span className="sherah-color4"><i className="fa fa-star"></i></span>
<span className="sherah-color4"><i className="fa fa-star"></i></span>
<span className="sherah-color4"><i className="fa fa-star"></i></span>
...
<p className="sherah-user-reviews__text">Rreally liked it! What a beautiful light it comes from! The radius of bright.</p>
<div className="sherah-user-reviews__buttons">
<a href="#" className="sherah-color3 sherah-color3__bg--opactity">
<svg xmlns="http://www.w3.org/2000/svg" width="17.136" height="15.5" viewBox="0 0 17.136 15.5">
<path id="Icon" d="M106.729,13.669v.694a.779.779,0,0,0-.022.1,5.407,5.407,0,0,1-.909,2.507,10.756,10.756,0,0,1-1.877,2.153c-1.417,1.265-2.855,2.505-4.29,3.75a.9.9,0,0,1-1.28-.03q-1.646-1.415-3.287-2.836a17.082,17.082,0,0,1-2.561-2.63,5.638,5.638,0,0,1-1.136-2.513,4.777,4.777,0,0,1,1.049-4.005,4.03,4.03,0,0,1,3.775-1.423,3.938,3.938,0,0,1,2.419,1.328c.138.149.264.31.4.477.069-.089.128-.169.192-.246s.135-.162.208-.239A3.931,3.931,0,0,1,103.71,9.6a4.192,4.192,0,0,1,2.863,3.17C106.65,13.062,106.679,13.368,106.729,13.669Z" transform="translate(-90.443 -8.519)" fill="none" stroke="#09ad95" stroke-width="1.7" />
...
<div className="sherah-user-reviews__single">
<div className="shera-user-reviews_thumb">
<img src="admin-asset/img/review-4.png"/>
</div>
<div className="sherah-user-reviews__content">
<h4 className="sherah-user-reviews_title">Deniella Rhodes</h4>
<div className="sherah-product-card__rating sherah-dflex sherah-flex-gap-5">
...
<form className="sherah-wc__form-main sherah-form-main--v2 p-0" action="#" method="post">
<div className="row">
<div className="col-lg-6 col-md-6 col-12">
<div className="form-group">
<label className="sherah-wc__form-label">First Name *</label>
<div className="form-group__input">
<input className="sherah-wc__form-input" placeholder="Your name here" type="text" name="f_name" required="required"/>
</div>
</div>
</div>
<div className="col-lg-6 col-md-6 col-12">
...
<div className="form-group__input">
<input className="sherah-wc__form-input" placeholder="Your email address here" type="text" name="e_address" required="required"/>
</div>
</div>
</div>
<div className="col-12">
...
<div className="form-group__input">
<textarea className="sherah-wc__form-input sherah-wc__form-input--big" placeholder="Write your text" type="text" name="d_area" required="required"></textarea>
</div>
</div>
</div>
</div>
<div className="form-group mg-top-30">
<button type="submit" className="sherah-btn sherah-btn__primary">Submit Now</button>
</div>
</form>
</div>
